...
* Your students and coaches/mentors are working together to build the robot. There aren’t any rules about who has to do what. FRC is designed to be a collaborative experience.
...
Mechanical SubTeams/Pods:

* Divide your robot into 4-5 mechanisms and divide your students into those groups.&#x20;
  * Examples: Drive, Intake, Elevator, Climber
...
* [FIRST Fundraising Tool Kit](https://www.firstinspires.org/sites/default/files/uploads/resource_library/frc/team-resources/frc-fundraising-guide.pdf)
* [Grant Database](https://docs.google.com/spreadsheets/d/1lbr_M25GZVA_DW-RVUw13W2dVzSI5aT0xvNVVkmjHno/edit?gid=768105605#gid=768105605)

Awards

* Please nominate 2 students for the Dean’s List every year and nominate 1 mentor for the Woodie Flowers Award Finalist every year. Even if you don’t think they can win the nomination, in and of itself, it is recognition for the hard work that people put into the program. The essays don’t need to take a long time to complete.
* During the season, you should identify one Judged award that your team best qualifies for and prepare your team to talk to the judges about that aspect of your team. You can print a couple of handouts and work with your students to review the talking points and details they should communicate to the judges during their session.
...
* Wood can be used, but should be used mostly internally on the robot, not in places where it will hit other robots.

Aluminum Tube / Extrusion

* Use pre-punched/drill tubes normally in 1x1 and 2x1 sizes in 1/16" and some 1/8" thickness.
* Use premade gussets/brackets.
  * Tubes: [REV Robotics](https://www.revrobotics.com/MAXTube/), [WCProducts](https://wcproducts.com/collections/systems-structure/tubing), [TheThriftyBot](https://www.thethriftybot.com/collections/structural), [Last Anvil](https://lastanvil.com/), [AndyMark](https://andymark.com/products/pre-drilled-box-tube-extrusion), [Swyft Robotics](https://swyftrobotics.com/products/swyft-super-tube?variant=50935967973670)
  * Gussets: [REV](https://www.revrobotics.com/1in-Brackets/), [WCP](https://wcproducts.com/collections/systems-structure/products/gussets), [Thrifty](https://www.thethriftybot.com/collections/structural), [AndyMark](https://andymark.com/collections/brackets-plates/products/1-2-in-pitch-gussets)

Shafts and Bearings

* Standardize on 1/2” Rounded Hex Shaft and Parts, 7075 is stronger than 6061
  * Shaft: [REV](https://www.revrobotics.com/.5in-Rounded-Hex-Shafts/), [WCP](https://wcproducts.com/products/shaft-stock), [TTB](https://www.thethriftybot.com/products/qty-1-36-inch-long-1-2-rounded-hex-shaft-6061-aluminum?_pos=1&_sid=e46abc0ee&_ss=r)&#x20;
* Compatible with 1/2” bearings, wheels, collars, etc.
  * Bearings: [Rev](https://www.revrobotics.com/ION-Bearings/?searchid=4962659\&search_query=bearing), [WCP](https://wcproducts.com/collections/cnc-hardware/products/ball-bearings), [Thrifty](https://www.thethriftybot.com/collections/bearings), [Swyft](https://swyftrobotics.com/products/bearings?_pos=5&_sid=ab512e5df&_ss=r)
...
* Flex/Compliant Wheels have become the most common wheels used in FRC.
  * Sizes 2 inch and 4 inch are the most common sizes
  * In most cases, using the softest available wheels is the easiest.
  * Wheels: [REV](https://www.revrobotics.com/ION-Compliant-Wheels/), [AndyMark](https://andymark.com/collections/compliant-intake/products/compliant-wheels), [WCP](https://wcproducts.com/collections/wheels-hubs/products/straight-flex-wheels-solid-core), [TTB](https://www.thethriftybot.com/collections/wheels-tread), [Swyft](https://swyftrobotics.com/products/swyft-intake-wheels),&#x20;
...
* If you aren’t moving to swerve this year, you should use the kit drive base with upgraded motors that will be used for swerve in future years.
* There are no good reasons to build a custom non-swerve drive-train anymore.
...
* Getting bins and things that can be transported to events is very helpful.
* We use regular Hefty bins from [Target](https://www.target.com/p/hefty-40qt-clear-plastic-storage-bin-with-gray-hi-rise-stackable-lid/-/A-16644160#lnk=sametab)/[Walmart](https://www.walmart.com/ip/Hefty-40-Quart-Clear-Plastic-Storage-Bin-with-Blue-HI-RISE-Lid-Adult/287444646?wmlspartner=wlpa\&selectedSellerId=0\&wmlspartner=wlpa\&cn=FY26-ENTP-PMAX_CVP_cnv_dps_dsn_dis_ad_entp_e_n\&gclsrc=aw.ds\&adid=22222222297287444646_0000000000_22488309517\&wl0=\&wl1=x\&wl2=c\&wl3=\&wl4=\&wl5=1014249\&wl6=\&wl7=\&wl8=\&wl9=pla\&wl10=8175035\&wl11=online\&wl12=287444646\&veh=sem\&gad_source=1\&gad_campaignid=22488321244\&gbraid=0AAAAADmfBIpTV1aLghnLQCnpAWVDZ6k9X\&gclid=CjwKCAiAu67KBhAkEiwAY0jAlR3ok_rJahdCsve2IMD6-FbgtkHwtulHlOohV8bpvPfF34uImeuPfRoCZ6kQAvD_BwE)

3D Printed Parts

* 3D printing can be extremely useful for FRC Robots. You can make parts directly, templates to help cut and drill parts, etc.
* PETG, PLA+, or higher-temperature filaments such as nylons or polycarbonate can all work for FRC-printed parts.

CNC Services

* If you don’t have your own Laser Cutter or CNC Router yet, you can have parts made by multiple vendors.
...
* [FIRST Safety Manual](https://www.firstinspires.org/sites/default/files/uploads/resource_library/frc/team-resources/safety/ftc-frc-safety-manual.pdf)
...
* Make sure you have your team rosters printed out and give them to the pit admin to get your driver buttons and team packet.

Inspection

* Try to begin your inspection as early as possible. The inspectors are there to help make sure your robot is legal. They can tell you what you may need to change and help you get assistance, parts, tools, etc.

Ways to help get you selected for the playoffs

* Never miss a match; even if your robot can only drive, that’s okay.
...
* You should have at least one pit student in your pit at all times. The judges and other teams may come by and ask questions at any point. Have shifts for lunch or to watch your matches, etc.
...
* When limited on team members, try running only qualitative match scouting/find scouting alliances.
  * [QR Scout](https://frc2713.github.io/QRScout/) can be run on any device and can be configured to match your needs.&#x20;
* Use existing resources, such as Statbotics and TheBlueAlliance Insights OPR, to make informed strategic decisions.
